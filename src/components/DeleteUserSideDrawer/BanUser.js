  ...
  return (
    <SideDrawerN>
      <div className="flex flex-col w-96">
        ...
        <button className="absolute bottom-10 py-2 px-4 bg-indigo-400 text-white w-24 transition ease-in duration-200 hover:bg-indigo-600 text-center text-base focus:outline-none rounded-sm">
          Ban user
        </button>
      </div>
    </SideDrawerN>
